...
export function makeServer({ environment = 'test' } = {}) {
  return createServer({
    ...
    routes() {
      ...
      this.get('/TRACK;NTRACK;GET/TRACK/5/SEND/0;GET/TRACK/5/SEND/-1;GET/TRACK/5/SEND/-2;GET/TRACK/5/SEND/-3', () => {
      ...
      this.get('/TRACK;NTRACK;GET/TRACK/4/SEND/0;GET/TRACK/4/SEND/-1;GET/TRACK/4/SEND/-2;GET/TRACK/4/SEND/-3', () => {
        return 'TRACK\t0\tMASTER\t520\t1.000000\t0.000000\t-1500\t-1500\t1.000000\t0\t0\t0\t1\t0\n' +
          'TRACK\t1\tAdamGtr\t128\t1.000000\t0.000000\t-1500\t-1500\t1.000000\t3\t2\t0\t0\t0\n' +
          'TRACK\t2\tSteveBass\t128\t1.000000\t0.000000\t-1500\t-1500\t1.000000\t3\t2\t0\t0\t0\n' +
          'TRACK\t3\tKrisGtr\t128\t1.000000\t0.000000\t-1500\t-1500\t1.000000\t3\t2\t0\t0\t0\n' +
